  ...
  <div :class="activeTheme">
    <div class="font-sans antialiased min-h-screen bg-primary text-secondary">
      ...
      <div v-else-if="fileExists()">
        <div class="absolute top-0 bottom-72 left-0 right-0">
          <div class="absolute border top-0 bottom-0 left-0 right-0">
        ...
        <div class="absolute bottom-0 right-0 left-0 h-72 border">
